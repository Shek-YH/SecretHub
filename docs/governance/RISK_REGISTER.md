...
| RSK-009 | Real Provider proxy forwarding unverified | High | Bounded HTTP forwarding and unauthorized rejection tested; require local sandbox credential for end-to-end smoke | Waiting user |
