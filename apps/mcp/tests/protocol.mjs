...
try {
  ...
  assert.deepEqual(item, { id: 'secret-fixture', name: 'Fixture Metadata', provider: 'generic', envKey: 'FIXTURE_KEY', status: 'unknown', tags: ['test'], hasValue: true, valueType: 'token', category: 'other', scope: 'global', favorite: false, archived: false, modelId: '', modelEnvKey: '' });
