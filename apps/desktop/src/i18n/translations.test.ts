import { getTranslation, readStoredLocale, translations } from './translations';
...
describe('locale contract', () => {
  it('uses Chinese by default and has a complete English dictionary', () => {
    ...
    expect(readStoredLocale('unexpected')).toBe('zh-CN');
    expect(readStoredLocale('en-US')).toBe('en-US');
  });
});
