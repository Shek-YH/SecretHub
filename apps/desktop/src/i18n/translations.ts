...
export type Translation = {
  ...
  form: { addTitle: string; editTitle: string; name: string; envKey: string; provider: string; value: string; valueType: string; category: string; scope: string; favorite: string; notes: string; tags: string; cancel: string; save: string; required: string };
...
export const translations: Record<Locale, Translation> = {
  'zh-CN': {
    ...
    form: { addTitle: '添加凭据', editTitle: '编辑凭据', name: '名称', envKey: '环境变量名', provider: '服务商', value: 'Secret 值', valueType: '值类型', category: '分类', scope: '作用域', favorite: '加入收藏', notes: '备注', tags: '标签（逗号分隔）', cancel: '取消', save: '保存凭据', required: '必填' },
  ...
  'en-US': {
    ...
    form: { addTitle: 'Add secret', editTitle: 'Edit secret', name: 'Name', envKey: 'Environment key', provider: 'Provider', value: 'Secret value', valueType: 'Value type', category: 'Category', scope: 'Scope', favorite: 'Favorite', notes: 'Notes', tags: 'Tags (comma separated)', cancel: 'Cancel', save: 'Save secret', required: 'Required' },
