...
export type Translation = {
  ...
  list: { title: string; selected: string; empty: string; searchEmpty: string; provider: string; updated: string; valid: string; unknown: string; active: string; all: string; allCategories: string; allStatuses: string; favoriteOnly: string; includeArchived: string };
  detail: { title: string; masked: string; provider: string; envKey: string; status: string; tags: string; notes: string; copy: string; copyApiKey: string; copyAll: string; reveal: string; validate: string; edit: string; delete: string; deleteConfirm: string; noSelection: string };
  actions: { export: string; import: string; profile: string; validate: string; archive: string; chooseFolder: string; preview: string; exportDone: string; operationFailed: string; importFormat: string; importContent: string; importPreview: string; confirmImport: string; imported: string };
...
export const translations: Record<Locale, Translation> = {
  'zh-CN': {
    ...
    list: { title: '凭据', selected: '已选择', empty: '还没有凭据', searchEmpty: '没有匹配的凭据', provider: '服务商', updated: '更新于', valid: '有效', unknown: '待验证', active: '使用中', all: '全部', allCategories: '全部分类', allStatuses: '全部状态', favoriteOnly: '仅收藏', includeArchived: '含已归档' },
    detail: { title: '凭据详情', masked: '已安全遮罩', provider: '服务商', envKey: '环境变量', status: '状态', tags: '标签', notes: '备注', copy: '复制', copyApiKey: '复制 API Key', copyAll: '复制全部内容', reveal: 'Reveal', validate: '验证', edit: '编辑', delete: '删除', deleteConfirm: '确定删除这条凭据？', noSelection: '选择一条凭据查看详情' },
    actions: { export: '导出', import: '导入', profile: '加入组合', validate: '批量验证', archive: '归档', chooseFolder: '选择项目目录', preview: '预览 .env', exportDone: '导出完成', operationFailed: '操作失败', importFormat: '导入格式', importContent: '粘贴 .env 或 JSON 内容', importPreview: '预览字段', confirmImport: '确认并加密导入', imported: '已导入并加密保存' },
  ...
  'en-US': {
    ...
    list: { title: 'Secrets', selected: 'selected', empty: 'No secrets yet', searchEmpty: 'No matching secrets', provider: 'Provider', updated: 'Updated', valid: 'Valid', unknown: 'Not validated', active: 'Active', all: 'All', allCategories: 'All categories', allStatuses: 'All statuses', favoriteOnly: 'Favorites only', includeArchived: 'Include archived' },
    detail: { title: 'Secret details', masked: 'Safely masked', provider: 'Provider', envKey: 'Environment key', status: 'Status', tags: 'Tags', notes: 'Notes', copy: 'Copy', copyApiKey: 'Copy API key', copyAll: 'Copy all fields', reveal: 'Reveal', validate: 'Validate', edit: 'Edit', delete: 'Delete', deleteConfirm: 'Delete this secret?', noSelection: 'Select a secret to view details' },
