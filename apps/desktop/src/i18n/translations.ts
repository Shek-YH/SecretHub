...
export const translations: Record<Locale, Translation> = {
  'zh-CN': {
    ...
    form: { addTitle: '添加凭据', editTitle: '编辑凭据', typeTitle: '选择凭据类型', apiKeyType: 'API KEY', tokenType: 'TOKEN', urlType: 'URL', passwordType: 'Password', textType: 'Text', apiKeyHint: '大模型厂商 API Key 与模型配置', tokenHint: '访问令牌、GitHub Token 等', urlHint: '项目地址、接口地址或服务网址', passwordHint: '数据库密码、登录密码等', textHint: '普通文本配置或备注值', back: '返回上一步', name: '名称', envKey: '环境变量名', provider: '服务商', value: 'Secret 值', model: '模型', modelEnvKey: '模型环境变量', valueType: '值类型', category: '分类', scope: '作用域', favorite: '加入收藏', notes: '备注', tags: '标签（逗号分隔）', cancel: '取消', save: '保存凭据', required: '必填' },
  ...
  'en-US': {
    ...
    form: { addTitle: 'Add secret', editTitle: 'Edit secret', typeTitle: 'Choose credential type', apiKeyType: 'API KEY', tokenType: 'TOKEN', urlType: 'URL', passwordType: 'Password', textType: 'Text', apiKeyHint: 'LLM provider API key and model configuration', tokenHint: 'Access tokens, GitHub tokens and similar values', urlHint: 'Project, endpoint or service URL', passwordHint: 'Database or login password', textHint: 'Plain text configuration or notes', back: 'Back', name: 'Name', envKey: 'Environment key', provider: 'Provider', value: 'Secret value', model: 'Model', modelEnvKey: 'Model environment key', valueType: 'Value type', category: 'Category', scope: 'Scope', favorite: 'Favorite', notes: 'Notes', tags: 'Tags (comma separated)', cancel: 'Cancel', save: 'Save secret', required: 'Required' },
